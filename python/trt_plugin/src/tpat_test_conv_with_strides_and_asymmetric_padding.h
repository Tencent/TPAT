...
class tpat_test_conv_with_strides_and_asymmetric_padding: public IPluginV2DynamicExt {
public:
    tpat_test_conv_with_strides_and_asymmetric_padding() {}
    
    tpat_test_conv_with_strides_and_asymmetric_padding(const void *buffer, size_t length) {
    }
    ...
    nvinfer1::IPluginV2DynamicExt* clone() const noexcept override {
        return new tpat_test_conv_with_strides_and_asymmetric_padding();
    }
    ...
    nvinfer1::DimsExprs getOutputDimensions(int outputIndex, const nvinfer1::DimsExprs* inputs, int nbInputs, nvinfer1::IExprBuilder& exprBuilder) noexcept override {
        ...
        if (outputIndex == 0){
            ...
            output_shape.d[2] = exprBuilder.constant(4);
    ...
    const char* getPluginType() const noexcept override {return "tpat_test_conv_with_strides_and_asymmetric_padding";}
...
class tpat_test_conv_with_strides_and_asymmetric_paddingCreator: public nvinfer1::IPluginCreator {
public:
    tpat_test_conv_with_strides_and_asymmetric_paddingCreator(){
    ...
    nvinfer1::IPluginV2DynamicExt* deserializePlugin(const char* name, const void* serialData, size_t serialLength) noexcept override {
        tpat_test_conv_with_strides_and_asymmetric_padding* obj = new tpat_test_conv_with_strides_and_asymmetric_padding{serialData, serialLength};
        obj->setPluginNamespace(mNamespace.c_str());
        return obj;
    }
    
    const char* getPluginName() const noexcept override {return "tpat_test_conv_with_strides_and_asymmetric_padding";}
    const char* getPluginVersion() const noexcept override {return "1";}
    ...
    nvinfer1::IPluginV2DynamicExt* createPlugin(const char* name, const nvinfer1::PluginFieldCollection* fc) noexcept override {
        //std::cout << __FUNCTION__ << std::endl;
        tpat_test_conv_with_strides_and_asymmetric_padding* obj = new tpat_test_conv_with_strides_and_asymmetric_padding{};
        obj->setPluginNamespace(mNamespace.c_str());
        return obj;
    }
private:
