...
class tpat_test_gatternd: public IPluginV2DynamicExt {
public:
    tpat_test_gatternd() {}
    
    tpat_test_gatternd(const void *buffer, size_t length) {
    }
    ...
    const char* getPluginType() const noexcept override {return "tpat_test_gatternd";}
...
class tpat_test_gatterndCreator: public nvinfer1::IPluginCreator {
public:
    tpat_test_gatterndCreator(){
    ...
    nvinfer1::IPluginV2DynamicExt* deserializePlugin(const char* name, const void* serialData, size_t serialLength) noexcept override {
        tpat_test_gatternd* obj = new tpat_test_gatternd{serialData, serialLength};
        obj->setPluginNamespace(mNamespace.c_str());
        return obj;
    }
    
    const char* getPluginName() const noexcept override {return "tpat_test_gatternd";}
    const char* getPluginVersion() const noexcept override {return "1";}
    ...
    nvinfer1::IPluginV2DynamicExt* createPlugin(const char* name, const nvinfer1::PluginFieldCollection* fc) noexcept override {
        //std::cout << __FUNCTION__ << std::endl;
        tpat_test_gatternd* obj = new tpat_test_gatternd{};
        obj->setPluginNamespace(mNamespace.c_str());
        return obj;
    }
private:
