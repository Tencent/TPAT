...
class tpat_test_lstm_bs1: public IPluginV2DynamicExt {
public:
    tpat_test_lstm_bs1() {}
    
    tpat_test_lstm_bs1(const void *buffer, size_t length) {
    }
    ...
    const char* getPluginType() const noexcept override {return "tpat_test_lstm_bs1";}
...
class tpat_test_lstm_bs1Creator: public nvinfer1::IPluginCreator {
public:
    tpat_test_lstm_bs1Creator(){
    ...
    nvinfer1::IPluginV2DynamicExt* deserializePlugin(const char* name, const void* serialData, size_t serialLength) noexcept override {
        tpat_test_lstm_bs1* obj = new tpat_test_lstm_bs1{serialData, serialLength};
        obj->setPluginNamespace(mNamespace.c_str());
        return obj;
    }
    
    const char* getPluginName() const noexcept override {return "tpat_test_lstm_bs1";}
    const char* getPluginVersion() const noexcept override {return "1";}
    ...
    nvinfer1::IPluginV2DynamicExt* createPlugin(const char* name, const nvinfer1::PluginFieldCollection* fc) noexcept override {
        //std::cout << __FUNCTION__ << std::endl;
        tpat_test_lstm_bs1* obj = new tpat_test_lstm_bs1{};
        obj->setPluginNamespace(mNamespace.c_str());
        return obj;
    }
private:
